...
export default function LandingPage() {
  ...
  return (
    <section className="landing-page">
      ...
      <div className="blob blob-supporting" aria-hidden="true" />
      <div className="blob blob-mint" aria-hidden="true" />
      <div className="blob blob-element" aria-hidden="true" />
      ...
      <main className="hero">
        ...
        <div className="face-container">
          ...
          <span className="eye-scroll-indicator eye-scroll-indicator-right">
            down
          </span>
        </div>
      </main>
        ...
        <div className="language-toggle">
          <button
            ...
            className={`language-option ${
              language === "VN" ? "language-option-active" : ""
            }`}
          ...
          <button
            type="button"
            className={`language-option ${
              language === "EN" ? "language-option-active" : ""
            }`}
